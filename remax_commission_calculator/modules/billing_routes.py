"""
Billing / Facturación HTTP routes registered on the Flask app.
"""
...
def register_billing_routes(app, *, helpers):
    """
    helpers: dict with
      require_user_organization, require_billing_user,
      flash_i18n, ensure_operation_scope,
      _flash_invoicing_error, _load_billing_invoice
    """
    ...
    def billing_list():
        ...
        pending_ops = list_pending_operations(
            organization_id,
            agent_id=agent_scope,
        )
